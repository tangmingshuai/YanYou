 ...
 * Generated for Laravel 5.5.40 on 2018-06-05 22:56:57.
 *
...
namespace App\Facades { 
    ...
    class Common {
         ...
         * @static 
         */ 
        public static function post($body, $apiStr, $postType, $referer = '', $cookie_jar = null)
        {
            return \App\Logic\CommonUtilLogic::post($body, $apiStr, $postType, $referer, $cookie_jar);
        }
        ...
        {
            return \App\Logic\CommonUtilLogic::get($apiStr, $cookie_jar, $referer);
        }
        ...
        {
            return \App\Logic\CommonUtilLogic::domCrawler($dom, $filterType, $filterRule);
        }
